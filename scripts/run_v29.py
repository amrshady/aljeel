#!/usr/bin/env python3
"""
AlJeel AP Pipeline v28 — Strict both-token name matching
...
# v29: CHD/INF dependent passenger emp_no suppression
# Uses employee_resolver_v2 v29_dependent_guard (before L0) and
# patched apply_family_cluster_unification in run_v16 (skips CHD/INF rows).
try:
    import full_evidence_agent_v28 as fea
except ImportError:
...
def main():
    ...
    # v28 NOTE: L0 validation was trialled but reverted — the Jawwal source system's
    ...
    # is applied inside the RESOLVERS (full_evidence_agent_v28 PRIORITY 2, and
    ...
    for i, c in enumerate(cascade_rows):
        ...
        if not name_parts:
            continue
        matched_eno = None
        # v28: two-token match ONLY — both first AND last name required.
